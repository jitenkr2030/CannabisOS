-- CannabisOS Database Schema for Neon PostgreSQL
...
-- Insert demo data
INSERT INTO "stores" ("id", "name", "address", "phone", "email", "licenseNumber", "timezone", "currency", "createdAt", "updatedAt") VALUES 
...
-- Insert demo users (password is 'demo123' hashed)
INSERT INTO "users" ("id", "email", "name", "password", "role", "phone", "storeId", "createdAt", "updatedAt") VALUES 
...
INSERT INTO "products" ("id", "name", "description", "sku", "category", "thcContent", "cbdContent", "weight", "unit", "price", "cost", "tags", "storeId", "createdAt", "updatedAt") VALUES 
...
INSERT INTO "inventory" ("id", "quantity", "available", "reorderLevel", "maxStock", "location", "productId", "storeId", "createdAt", "updatedAt") VALUES 
...
-- Insert demo sales
INSERT INTO "sales" ("id", "receiptNumber", "customerName", "customerPhone", "customerEmail", "subtotal", "tax", "total", "paymentMethod", "status", "ageVerified", "verifiedBy", "storeId", "userId", "createdAt", "updatedAt") VALUES 
...
INSERT INTO "sale_items" ("id", "quantity", "unitPrice", "total", "saleId", "productId", "createdAt") VALUES 
...
INSERT INTO "expenses" ("id", "description", "amount", "category", "date", "notes", "storeId", "userId", "createdAt", "updatedAt") VALUES 
...
INSERT INTO "deliveries" ("id", "orderNumber", "customerName", "customerPhone", "customerAddress", "status", "estimatedTime", "distance", "storeId", "driverId", "createdAt", "updatedAt") VALUES 
...
-- Insert demo delivery items
INSERT INTO "delivery_items" ("id", "quantity", "productName", "thcContent", "cbdContent", "deliveryId", "createdAt") VALUES 
('del-item-001', 1, 'Blue Dream', 18.5, 0.2, 'del-001', CURRENT_TIMESTAMP),
('del-item-002', 1, 'OG Kush', 22.0, 0.1, 'del-002', CURRENT_TIMESTAMP)
ON CONFLICT DO NOTHING;

-- Insert demo batches
INSERT INTO "batches" ("id", "batchNumber", "supplier", "supplierLicense", "receivedDate", "expiryDate", "testDate", "labResults", "storeId", "createdAt", "updatedAt") VALUES 
...
INSERT INTO "qr_codes" ("id", "code", "productId", "isActive", "scanCount", "createdAt", "updatedAt") VALUES 
